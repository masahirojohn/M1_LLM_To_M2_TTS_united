...
from aituber_llm_tts.llm_client import DummyLLMClient
...
def main() -> None:
    ...
    ap.add_argument("--comments_json", default="examples/dummy_comments.json")
    ap.add_argument("--max_comments", type=int, default=5)
    ap.add_argument("--session_id", default="sess_real_01")
    ap.add_argument("--utt_id", default="utt_0001")
    ap.add_argument("--source", default="dummy_comments_json")
    args = ap.parse_args()
    ...
    out = llm.generate_unified_output_stub(
        state=state,
